...
# export product_instance_dir=/opt/csitea/znote-xtor/znote-xtor.0.2.8.dev.ysg
...
ok ( $ProductName          eq 'znote-xtor' , $msg ) ; 
...
# 10.
my $CnfFileToCompare       = "$ProductInstanceDir/cnf/znote-xtor." . $ProductType . '.' . $cmd_out . '.cnf' ; 
