package ZnoteXtor::App::RAM::CnrHsr2ToTxt ; 
...
=head1 SYNOPSIS
	...
	doResolves the product version and base dirs , bootstraps cnfig files if needed
      ...
      use ZnoteXtor::App::RAM::CnrHsr2ToTxt ; 
		my $objCnrHsr2ToTxt = 
			'ZnoteXtor::App::RAM::CnrHsr2ToTxt'->new ( \$appConfig ) ; 
=cut 
...
sub doConvertHashRefToStr {
  ...
  my $objTimer         = 'ZnoteXtor::App::Utils::Timer'->new( $appConfig->{ 'TimeFormat' } );
