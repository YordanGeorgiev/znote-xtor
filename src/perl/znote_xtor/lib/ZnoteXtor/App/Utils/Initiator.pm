package ZnoteXtor::App::Utils::Initiator ; 
...
=cut
	...
	sub doResolveMyConfFile {
      ...
      # cnf/znote-xtor.host-name.cnf
      # cnf/znote-xtor.dev.host-name.cnf
      # cnf/znote-xtor.tst.host-name.cnf
      # cnf/znote-xtor.prd.host-name.cnf
