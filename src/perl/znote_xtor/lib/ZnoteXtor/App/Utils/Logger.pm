package ZnoteXtor::App::Utils::Logger ;
...
Perhaps a little code snippet.
    ...
    use ZnoteXtor::Control::Utils::Logger ; 

    my $objLogger = ZnoteXtor::Control::Utils::Logger->new( \$appConfig ) ;
    ...
...
=cut 
   ...
   sub doInitialize {
      ...
      $appConfig->{ 'PrintConsoleMsgs' } = 1 
		...
		$objTimer               = 'ZnoteXtor::App::Utils::Timer'->new( $appConfig->{ 'TimeFormat' } );
