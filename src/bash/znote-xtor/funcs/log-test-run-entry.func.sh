# src/bash/znote-xtor/funcs/log-test-run-entry.func.sh
...
doLogTestRunEntry(){
   ...
   case "$1" in
     INIT)
         # cat doc/txt/znote-xtor/funcs/log-test-run-entry.func.txt
...
# eof file: src/bash/znote-xtor/funcs/log-test-run-entry.func.sh
