# src/bash/znote-xtor/funcs/clone-project.func.sh

# v1.0.9
# ---------------------------------------------------------
# cat doc/txt/znote-xtor/funcs/clone-project.func.txt
# ---------------------------------------------------------
doCloneProject(){
   ...
   export tgt_proj='phz'
   export global_cnf_dir='/vagrant/csitea/cnf/projects/znote-xtor'
...
# eof file: src/bash/znote-xtor/funcs/clone-project.func.sh
