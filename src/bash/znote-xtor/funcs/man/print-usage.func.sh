...
doPrintUsage(){
   ...
   1. setup a project : 
   doParseCnfEnvVars /vagrant/csitea/cnf/projects/znote-xtor/ysg-issues.dev.host-name.cn
   
   2. run an action:  

      bash src/bash/znote-xtor/znote-xtor.sh -a xls-to-db -t daily_issues,monthly_issues
      bash src/bash/znote-xtor/znote-xtor.sh -a db-to-xls -t daily_issues,monthly_issues
      bash src/bash/znote-xtor/znote-xtor.sh -a db-to-txt -t daily_issues,monthly_issues
      bash src/bash/znote-xtor/znote-xtor.sh -a txt-to-db -t daily_issues,monthly_issues

      bash $0 -a run-znote-xtor
