# src/bash/znote-xtor/funcs/check-perl-modules-prerequisites.spec.sh
...
doSpecCheckPerlModulesPrerequisites(){
	...
	cat doc/txt/znote-xtor/specs/check-perl-modules-prerequisites.spec.txt
...
# eof file: src/bash/znote-xtor/funcs/check-perl-modules-prerequisites.spec.sh
