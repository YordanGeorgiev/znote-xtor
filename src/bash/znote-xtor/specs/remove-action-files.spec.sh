# src/bash/znote-xtor/funcs/remove-action-files.spec.sh
...
doSpecRemoveActionFiles(){
	...
	cat doc/txt/znote-xtor/specs/remove-action-files.spec.txt
...
# eof file: src/bash/znote-xtor/funcs/remove-action-files.spec.sh
