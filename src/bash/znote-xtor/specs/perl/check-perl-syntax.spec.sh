# src/bash/znote-xtor/funcs/check-perl-syntax.spec.sh
...
doSpecCheckPerlSyntax(){
	...
	cat doc/txt/znote-xtor/specs/check-perl-syntax.spec.txt
...
# eof file: src/bash/znote-xtor/funcs/check-perl-syntax.spec.sh
