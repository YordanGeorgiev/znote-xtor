...
doTestCreateRelativePackage(){
   ...
   exit_code=0
	bash src/bash/znote-xtor/znote-xtor.sh -a create-relative-package
   export exit_code=$?
   ...
   bash src/bash/znote-xtor/znote-xtor.sh -a create-relative-package -i met/.tst.znote-xtor
   export exit_code=$?
   ...
   test $exit_code -ne 0 && return
	...
	bash src/bash/znote-xtor/znote-xtor.sh -a create-relative-package -i met/.prd.znote-xtor
   export exit_code=$?
   ...
   # test the call with the include file of the prd env
   bash src/bash/znote-xtor/znote-xtor.sh -a create-relative-package -i met/.git.znote-xtor
   export exit_code=$?
