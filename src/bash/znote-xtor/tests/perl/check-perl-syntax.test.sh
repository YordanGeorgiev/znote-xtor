# src/bash/znote-xtor/funcs/check-perl-syntax.test.sh
...
doTestCheckPerlSyntax(){
	...
	cat doc/txt/znote-xtor/tests/perl/check-perl-syntax.test.txt
...
# eof file: src/bash/znote-xtor/funcs/check-perl-syntax.test.sh
