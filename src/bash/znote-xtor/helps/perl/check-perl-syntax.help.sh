# src/bash/znote-xtor/funcs/check-perl-syntax.help.sh
...
doHelpCheckPerlSyntax(){
	...
	cat doc/txt/znote-xtor/helps/check-perl-syntax.help.txt
...
# eof file: src/bash/znote-xtor/funcs/check-perl-syntax.help.sh
