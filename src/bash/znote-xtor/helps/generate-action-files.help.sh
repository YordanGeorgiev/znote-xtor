# src/bash/znote-xtor/funcs/generate-action-files.help.sh
...
doHelpGenerateActionFiles(){
	...
	cat doc/txt/znote-xtor/helps/generate-action-files.help.txt
...
# eof file: src/bash/znote-xtor/funcs/generate-action-files.help.sh
